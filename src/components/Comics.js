...
class Comics extends Component {
    ...
    eliminarComic = (index) => {
        // Para eliminar un objeto de una coleccion se utiliza un metodo llamado 'splice'
        // este metodo recibe 2 parametors
        // 1) Indice a eliminar
                ...
                <h1>Comics Padre</h1>
                {
                    this.state.favorito && (
                        <div style={{backgroundColor:"yellow"}}>
                            ...
                            <img src={this.state.favorito.imagen} style={{ width: "150px" }}></img>
                        </div>
                    )
                }
